...
const messages = {
  item1: "Bananas are organic waste. Place them in the compost bin. They decompose naturally and enrich the soil. Did you know ? Researchers and entrepreneurs are exploring ways to use the fibrous properties of banana waste to create sustainable alternatives to plastic. It's an innovative way to tackle food waste while reducing plastic pollution",
  item2: "Juice boxes go in the trash bin. They are made of mixed materials that are not recyclable. Did you know ? Juice boxes can be recycled into cool products like notebooks or roof tiles by separating their layers of plastic, aluminium, and paperboard.",
  item3: "Bread is compostable. It breaks down easily and adds nutrients to compost. Did you know ? Bread is one of the most wasted foods globally.",
  item4: "Cardboard is recyclable. Recycling it saves energy and reduces waste in landfills. Did you know ? Cardboard is one of the easiest materials to recycle, and recycling one tonne of cardboard saves over 17 trees, 7,000 gallons of water, and 4,000 kilowatts of energy—enough to power a home for months!",
  item5: "Oranges belong in the compost bin. They add valuable organic matter to the compost.Did you know ?Orange peels can be turned into natural cleaners, essential oils, and even bio-pesticides. Sweet sustainability! ",
  item6: "Plastic forks go in the recycle bin. Recycling them reduces the need for new plastic production.Did you know ? Plastic forks can take hundreds of years to decompose, but they can be recycled into new plastic products, reducing waste and saving resources.",
};
